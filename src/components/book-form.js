    ...
    return (
      <div className="container">
        ...
        >
          ...
          <div class="form-group">
            <label for="photo">Upload book</label>
            <br></br>
            <input
              type="file"
              value={this.state.book.photo}
              // onChange={this.handleChange}
              onChange={this.state.captureFile}
              id="photo"
            />
          </div>
          ...
          <div class="float-right">
            {this.state.book.id ? (
              <button
                ...
                onClick={this.state.uploadFile}
              >
                <FontAwesomeIcon icon="paper-plane" /> Update
              </button>
            ) : (
              <button
                type="submit"
